...
class BasicauthIndexForm(forms.ModelForm):
	class Meta:
		remove = []
		model = Basicauth
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(BasicauthIndexForm, self).save(commit=commit)
		return instance

class BasicauthCreateForm(forms.ModelForm):
	class Meta:
		remove = []
		model = Basicauth
		fields, verbose_names, field_types = get_all_field_info(model, with_id=False, remove=remove)
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(BasicauthCreateForm, self).save(commit=commit)
		return instance

class BasicauthDetailForm(forms.ModelForm):
	class Meta:
		remove = []
		model = Basicauth
		fields, verbose_names, field_types = get_all_field_info(model, with_id=False, remove=remove)
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(BasicauthDetailForm, self).save(commit=commit)
		return instance

class BasicauthUpdateForm(forms.ModelForm):
	class Meta:
		remove = []
		model = Basicauth
		fields, verbose_names, field_types = get_all_field_info(model, with_id=False, remove=remove)
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(BasicauthUpdateForm, self).save(commit=commit)
		return instance
