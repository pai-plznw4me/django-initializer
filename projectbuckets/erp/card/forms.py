...
class CardIndexForm(forms.ModelForm):
	class Meta:
		remove = []
		model = Card
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(CardIndexForm, self).save(commit=commit)
		return instance
...
class CardCreateForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(CardCreateForm, self).save(commit=commit)
		return instance
...
class CardDetailForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(CardDetailForm, self).save(commit=commit)
		return instance
...
class CardUpdateForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(CardUpdateForm, self).save(commit=commit)
		return instance
