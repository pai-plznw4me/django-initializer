...
class PurchaseIndexForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(PurchaseIndexForm, self).save(commit=commit)
		return instance
...
class PurchaseCreateForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(PurchaseCreateForm, self).save(commit=commit)
		return instance
...
class PurchaseDetailForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(PurchaseDetailForm, self).save(commit=commit)
		return instance
...
class PurchaseUpdateForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(PurchaseUpdateForm, self).save(commit=commit)
		return instance
