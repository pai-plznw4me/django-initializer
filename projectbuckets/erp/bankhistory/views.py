...
def index(request):
	def _callback(**kwargs):
		pass;
	return standard_index(request, BankhistoryIndexForm, {}, None, 'bankhistory/', base, crud_formtable, None,  table_id='employee_index_table', table_classes=('cell-border'))

def create(request):
	def _callback(**kwargs):
		pass;
	return standard_create(request, 'standard/create.html', BankhistoryCreateForm, None, 'bankhistory:index', {}, base, None)

def detail(request, id):
	def _callback(**kwargs):
		pass;
	return standard_detail(request, id, 'standard/detail.html', BankhistoryDetailForm, None, base_form_detail, base, None)

def update(request, id):
	def _callback(**kwargs):
		pass;
	return standard_update(request, id, 'standard/update.html', BankhistoryUpdateForm, None, 'bankhistory:index', None, base, _callback)
