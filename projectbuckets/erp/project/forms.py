...
class ProjectIndexForm(forms.ModelForm):
	class Meta:
		remove = []
		model = Project
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(ProjectIndexForm, self).save(commit=commit)
		return instance
...
class ProjectCreateForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(ProjectCreateForm, self).save(commit=commit)
		return instance
...
class ProjectDetailForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(ProjectDetailForm, self).save(commit=commit)
		return instance
...
class ProjectUpdateForm(forms.ModelForm):
	...
	def save(self, commit=True, **form_additional_info):
		# 폼 저장 영역
		instance = super(ProjectUpdateForm, self).save(commit=commit)
		return instance
